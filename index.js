...
app.get("/basic", (req, res) => {
  ...
  let fnm = req.query.fname;
  let lname = req.query.lname;
  let deg = req.query.deg;
  let add1 = req.query.add1;
  let email = req.query.email;
  let add2 = req.query.add2;
  let phn_no = req.query.phn_no;
  let state = req.query.state;
  let city = req.query.ci;
  let gen = req.query.gen;
  let zipcode = req.query.zip;
  let rela = req.query.rela;
  let bod = req.query.bod;
...
app.get("/educationdetail", (req, res) => {
  let finaleduquery = req.query.finaleduquery;
...
app.get("/workexperience", (req, res) => {
  let finalworkquery = req.query.finalworkquery;
...
app.get("/language", (req, res) => {
  let finallangquery = req.query.finallangquery;
...
app.get("/technology", (req, res) => {
  let finaltechquery = req.query.finaltechquery;
  connection.query(finaltechquery, function (err, results) {
    // console.log(results);
  });
});

app.get("/referencecontact", (req, res) => {
  let finalrefquery = req.query.finalrefquery;
  connection.query(finalrefquery, function (err, results) {
    // console.log(results);
  });
});

app.get("/preferences", (req, res) => {
  let finalpreferences = req.query.finalpreferences;
  connection.query(finalpreferences, function (err, results) {
    console.log(results);
  });
});
